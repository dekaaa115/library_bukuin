...
// Kita ambil semua kolom karena admin bisa saja memiliki kolom 'kelas' dll.
...
$kelas = htmlspecialchars($user_data['kelas'] ?? 'N/A');
$role = htmlspecialchars($user_data['role'] ?? 'admin');
$gender = htmlspecialchars($user_data['gender'] ?? '');
// Ambil URL gambar dari session (yang sudah diupdate di process file)
$profile_image_url = htmlspecialchars($_SESSION['profile_image_url'] ?? 'https://placehold.co/100x100/A78BFA/FFFFFF?text=A');
        ...
        <nav class="w-64 bg-[#333333] p-6 flex flex-col justify-between">
            <div>
                <div class="flex flex-col items-center mb-10">
                    ...
                    <img src="../<?php echo $profile_image_url; ?>" onerror="this.onerror=null; this.src='https://placehold.co/100x100/A78BFA/FFFFFF?text=A';" alt="Admin Profile" class="rounded-full w-24 h-24 mb-4 border-2 border-green-500 object-cover">
                ...
                <ul>
                    ...
                    <li class="nav-item rounded-lg mb-2 active-nav"><a href="profil-admin.php" class="flex items-center p-3 rounded-lg"><i data-lucide="user-cog" class="mr-3"></i>Edit Profil</a></li>
                </ul>
            </div>
            <div>
        ...
        <main class="flex-1 flex flex-col">
            ...
            <header class="bg-[#A78BFA] text-black p-4 flex justify-between items-center shadow-md">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-semibold">Buku in - Edit Profil Admin</h1>
                </div>
            </header>

            <div class="flex-1 p-8 overflow-y-auto">
                <h2 class="text-3xl font-bold text-gray-300 mb-6">Edit Data Profil Admin</h2>
                ...
                <div class="bg-[#333333] p-8 rounded-xl shadow-lg max-w-3xl mx-auto">
                    ...
                    <form action="../php/update_profile_process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col items-center mb-8 pb-6 border-b border-gray-600">
                            ...
                            <img src="../<?php echo $profile_image_url; ?>" onerror="this.onerror=null; this.src='https://placehold.co/100x100/A78BFA/FFFFFF?text=A';" alt="Current Profile" class="rounded-full w-32 h-32 mb-4 border-4 border-red-500 object-cover">
